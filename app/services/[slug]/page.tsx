...
> = {
  ...
  honggildong: {
    ...
    quote: "Ayo, 왓썹 bro.",
    shortBio:
      "오브콜스 형제여, 네가 말한것 처럼 세상은 불합리할지도 모르지. 하지만 그 사실을 당당하게 마주하고 삶은 이어가는건 오직 용감한 인간만이 할 수 있는 일이야. 난 네 심장보다도 가까운곳에서 널 지켜볼테니까. 기적같은 하루가 널 기다리고 있어.",
    partner: {
      name: "Bro",
      animal: "여우",
      emoji: "🦊",
    ...
    birthplace: "활빈당",
    birthplaceDesc:
      "작은 시골마을에서 시작된 작은 무리. 아직 이야기의 초반이기 때문에 어줍잖은 왈패집단입니다. 홍길동과 bro 무리가 만든 '순수 청년 봉사 단체' 라는 뜻입니다.",
    fullBio:
      "'형'을 '형'이라고 부르지 못하고 '아버지'를 '아버지'라고 부르지 못하는 기구한 운명에 저항하는 인물입니다. '동'에 번쩍 '서'에 번쩍 '신출귀몰' 하며 특히 밤에 그는 '천하무적'입니다. 의롭고 용감하며 소울이 충만합니다. 가족의 사랑을 많이 받고 자란 티가납니다.",
    hiddenStory:
  ...
  naesi: {
    ...
    quote: "황송하옵니다~~~ 에예",
    shortBio:
      "조선을 팔도에 검술이 가장 뛰어난 자를 '조선제일검'이라고 부른다지. 자네는 '조선제십팔검'정도 되려나보군.",
    partner: {
      name: "내서",
      animal: "올빼미",
      emoji: "🦉",
    ...
    fullBio:
      "왕의 가장 옆에서 보좌하는 인물입니다. 어떠한 경우에도 왕을 따라다닙니다. 심지어 왕께서 화장실에 가실때도 말이죠. 짬이 좀 차서 그런지 왕 보기를 우습게 보는 것 같습니다. 하지만 이래 보여도 왕과 함께 피난길에 올랐던 충신입니다. 그래서인지 왕도 딱히 뭐라 하지 않습니다.",
    hiddenStory:
  ...
  igniter: {
    ...
    quote: "불꽃이 작다고 안뜨거운건 아니잖아.",
    shortBio:
      "가끔은 한 번에 불이 붙지 않을 때도 있습니다. 그럴 땐 열 번이고, 백 번이고 터뜨려서 결국 불을 붙여버립니다. 당신을요..",
    partner: {
      name: "이기",
      animal: "불도롱뇽",
      emoji: "🦎",
    ...
    birthplace: "인시피오 (Incipio)",
    birthplaceDesc:
      "제 6도시의 D와 H구역에 영향을 끼치고 있는 탄탄한 사기업 부동의 2위 기업 인시피오. 처음에는 정처없는 길거리 예술인들이 모이던 장소였지만, 하나 둘 모이면서 세력이 커져 회사처럼 되었습니다. 인시피오의 직원들은 검은 정장과 페도라를 쓰고 다니기 때문에 마피아같아 보이지만 사실은 예술인. 사실은 직원도 아닌 듯, 각자의 예술 활동을 하고있는 예술인들. 험악해 보이지만 의리 있고 친절합니다. 다른 도시보다 결집력이 높고 회사에대한 충성심이 높아보입니다.",
    fullBio:
      "시끄럽고 과격하지만 여러분들의 시작을 알리는 역할을 맡았습니다. 할 수 있는 거라곤 작은 스파크를 터트리는것이 전부지만, 그 정도로도 당신의 이야기를 시작하기에 충분합니다. 불이 약해지더라도 다시 한 번 터트리면 됩니다. 이그나이터와 함께 시작할 당신의 이야기를 기대하고 있습니다.",
    hiddenStory:
  ...
  navigator: {
    ...
    teamName: "스타터팩",
    gradient: "from-rose-500 via-pink-600 to-fuchsia-700",
    quote: "남들이 만들어 둔 지도에 네가 가고 싶은 곳이 나와 있어?",
    shortBio:
      "그럼에도 길을 자주 확인해야 합니다. 가끔은 길을 안내하고 있는 당신을 발견할 수 있을 겁니다.",
    partner: {
      name: "알버트",
      animal: "비둘기",
      emoji: "🕊️",
      desc: "바보새 알버트. 네비게이커가 어깨에 올려두고 다니는 비둘기입니다. 평소 무슨생각을 하는지 알 수 없습니다. 공원에서 자주 보입니다.",
    },
    birthplace: "마우스피스",
    birthplaceDesc:
      "도시의 가장 밑부분에 자리한, 갈 곳 없는 자들의 거리. 모든 도시에서 쫓겨나거나 도망친 사람들이 모여 만들어진 낙오지구입니다. 도시의 오·폐수가 흐르는 관을 따라, 조그마한 공간마다 사람들이 머물며 하나의 도시가 생겨났습니다. 관은 얼기설기 얽혀 있어, 지도가 없다면 빠져나올 수 없습니다. 사람들은 늘 힘들고 배고프지만, 서로를 도우며 살아갑니다. 언젠가 햇볕이 들 그날을 상상하면서요.",
    fullBio:
      "네비게이터는 사실 길 찾기에는 재능이 없습니다. 지도도 볼 줄 모르고요. 원래라면 이그나이터가 되었을 아이입니다. 어째서인지 네비게이터로 선택되었지만, 운명이 이렇게 만든 데에는 분명 이유가 있을테지요. 하지만 걱정하지 마세요. 네비게이터의 굳은 마음은 길을 잃지 않습니다. 늘 새로운 길로 나아갑니다. 물론 그 길이 평탄할지는 가 봐야 알 수 있습니다.",
    hiddenStory:
  ...
  celebrator: {
    ...
    teamName: "스타터팩",
    gradient: "from-rose-500 via-pink-600 to-fuchsia-700",
    quote: "이것도 축하해… 이것도…, …이건, 아닌가?",
    shortBio:
      "시작하고 난 후의 모든 순간은, 축하할 일들로 가득합니다. 당신의 이야기와 추억 하나하나를, 우리는 축하합니다.",
    partner: {
      name: "봉봉이",
      animal: "호박벌",
      emoji: "🐝",
    ...
    birthplace: "인덱스랩(C-Index Lab)",
    birthplaceDesc:
      "제2도시 전 구역을 관장하고 있는 제1 사기업, 인덱스랩(Index Lab). 2위 기업인 인시피오(Incipio)와는 상당한 격차를 유지한 채, 오랫동안 그 자리를 지켜오고 있습니다. 과거 정부 산하 과학기관의 연구원이 설립한 인덱스랩은, 거대한 규모에 비해 외부에 공개된 정보가 극히 제한적입니다. 철저하게 통제된 운영 방식과 수많은 비공개 프로젝트들. 그 실체를 아는 이는 거의 없으며, 그들이 무엇을 연구하는지조차 명확히 밝혀진 바 없습니다. 다만 한 가지 분명한 것은— 이 기업이 단순한 연구소 이상의 무언가라는 사실입니다.",
    fullBio:
      "셀러브레이터는 여러분의 시작을 함께 축하합니다. 모험이 시작되는 순간부터, 이미 축하할 일들로 가득하니까요. 행복은 나눌수록 커진다고 하죠. 셀러브레이터와 함께, 그 모든 순간을 축하해 보세요.",
    hiddenStory:
