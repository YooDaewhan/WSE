...
const generations = [
  ...
  },
  {
    ...
    emoji: "🌓",
    philosophy:
      "낮과 밤이 정확히 같은 길이로 겹치는 날, 이퀴녹스가 태어났습니다. 이들은 빛이기도 그림자이기도 하며, 어느 쪽도 포기하지 않습니다. 극단의 중심을 지키는 일이 이들의 과업입니다.",
  ...
  },
  {
    ...
    description:
      "체계와 질서의 화신. 시큐리티엑스는 조직력으로 모든 것을 지켜내는 최강의 방패다.",
    gradient: "from-blue-600 via-sky-600 to-cyan-500",
    emoji: "🛡️",
    philosophy:
      "혼돈 앞에서 가장 필요한 것은 구조입니다. 시큐리티엑스는 위계와 협력이라는 두 축 위에서, 흐트러지지 않는 질서를 만들어냅니다. 인턴에서 부장까지 — 모든 단계가 하나의 벽을 이룹니다.",
    motto: "결정의 무게를 아는 자, 최종 방어선.",
    theme: "질서 · Order",
    members: [
      {
        name: "인턴",
