...
> = {
  ...
  "1": {
    ...
    directorNote: {
      date: "2024년 3월 1일",
      opening:
        "안녕하세요 새벽조의 디렉터 김선우입니다. 새벽조는 MCM의 첫 기수로서, 앞으로 나올 모든 기수와 회사의 운명까지도 여러분께 달렸습니다. 여러분들 께서 열심히 활동하시어 우리를 세상에 일려주셔야 다음 기수도 나올 수 있습니다. 저희 역시 최선을 다해 새벽조 여러분을 돕겠습니다. 여러분이 이 팀의 첫 멤버로서 그 길을 함께 걸어주셔서 정말 감사드립니다.",
      origin:
        "우리 새벽조는 보는 사람들로 하여금 고난을 이겨내는 모습을 보여주기 위해 기획되었습니다. 전통에 맞서는 홍길동, 죽음에 저항하는 도깨비, 신분에 맞서는 내시, 외세에 저항하는 독립운동가의 컨셉입니다. ",
      direction:
        "컨셉은 컨셉일뿐 자신의 스타일에 맞게 잘 방송해주시면 되겠습니다.",
      closing: "잘 부탁드립니다.",
    },
    classified: {
      ...
      items: [
        {
          label: "의도적 유예",
          content:
            "호테이 센지는 의도적으로 유예됩니다. 아마 호테이센지는 공개시부터 논란이 될 가능성이 높아 의도적으로 유예할 예정입니다. 이후 논란이 줄어들면 외국인맴버 기수때 기습적으로 데뷔할 예정입니다.",
        },
        {
          label: "미정",
          content: "미정",
  ...
  "5": {
    ...
    directorNote: {
      date: "2025년 3월 1일",
      opening:
        "이퀴녹스는 [차가운 진실이라면, 거짓말은 따듯하겠지]라는 말을 모티브를 두고 설계하였습니다. 노력하고 지친자들을 위한 팀 입니다.",
      origin:
        "천사들은 노력과 열정을, 악마들은 지침과 위로를 담당해야합니다. 치열한 세상 우리는 항상 앞으로만 달려가고 있습니다. 우리에겐 노력과 휴식이 균형적으로 필요합니다. 천사들은 노력하지 않고 미루는 사람들에게 경각심을 주어야합니다. 악마들은 너무 노력만해 쉬는 것이 두려운 사람들에게 경각심을 주어야합니다. 천천 천악 악천 악악 으로 나뉘어집니다. 천으로 갈수록 노력을 강조해야하고 악으로 갈수록 휴식을 강조해야합니다. 중간의 각진영의 문제점을 깨닿고 반대쪽의 중요성을 알게되어 전향한 인물입니다. 하지만 전향 전 베이스는 어쩔 수 없이 유지한 뉘앙스를 가져야합니다. 자신은 변하려고 노력하지만 태생이 남아있음이 느껴지게해야합니다.",
      direction: "천사들은 작은 가슴 긴머리 악마들은 큰가슴 짧은머리 입니다.",
      closing:
        "어느 한쪽이 옳다고 할 수는 없습니다. 시청자들로 하여금 자신을 돌아보고 지금 자신에게 필요한것을 알 수 있게 해주어야합니다.",
    },
    classified: {
      ...
      items: [
        {
          label: "아자젤라",
          content:
            "이자젤라는 날개가없습니다. 악마에서 개종한 천사입니다. 천계는 한번 찍은 낙인을 지우지않고 계속하여 낙인을 심는 고지식한느낌",
        },
        {
          label: "종교적 표현 검토",
          content:
  ...
  "7": {
    ...
    directorNote: {
      date: "2025년 9월 1일",
      opening: "시큐리티엑스는 사실 과학화기계군단입니다.",
      origin:
        "세큐리티엑스는 사설 경호 업체입니다. 미녀 경호원들로 이루어진 mvp 경호 회사라고 볼 수 있죠. 시청자들로 하여금 미녀 경호원에대한 로망을 심어줍니다. 물론 전 인원역시 경호임무에 특화되어있습니다. 사실은 모두 특수군인 출신이거든요. 특수 임무중 재기불능할 정도의 치명적인 부상을 입은 군인들의 손상된 신체를 기계화 장비로 대체하여 어느정도까지 복원이 가능한지 실험하는 실험의 대상체들입니다. 첫 데뷔를 제외하고 이후에는 사복차림으로 활동할 계획입니다.",
      direction:
        "시큐리티엑스는 시청자들을 어쩔수없는 꼬마 도련님 이라는 느낌으로 정체를 들키지 않고 잘 경호하는 느낌으로 연기해야합니다. 말썽쟁이 꼬마를 어르고 달래는 느낌으로요. 다들 강하고 여성스러운 면이 적지만 경호를 위해 연기하는톤으로 부탁드립니다.",
      closing: "여러분들의 사복차림은 최대한 귀여운 옷으로 준비됩니다.",
    },
    classified: {
      ...
      items: [
        {
          label: "군인 출신 설정",
          content:
            "보통 우리는 1주년때 비하인드 스토리를 공개 하기때문에 1주년에 공개될 것같습니다. 공개시 직급, 부상범위, 마지막작전 등이 될것 같습니다.",
        },
        {
          label: "계급",
          content:
            "사실 모두는 같은 부대도, 실제 계급도 섞여있습니다. 직급이 계급 순이 아니라는 것이죠. 나중에 계급이 밝혀졌을때를 재미있게 풀어주세요.",
        },
        {
          label: "미정",
          content: "미정",
    ...
    operations: {
      items: [
        ...
        {
          text: "직급차이로 인한 위계로 재미있는 장면을 만들어주세요.",
          level: "권고",
        },
        {
          text: "상사 뒷담컨텐츠는 어떨까요",
        ...
        {
          text: "직급과 군인일때의 계급은 다릅니다. 인턴이 가장 높은계급이였고 부장님이 가장 낮은 계급이였을 수도 있습니다.",
          level: "인식",
        },
      ],
      teamNote:
        "시청자들의 짖궂은 장난을 의도하고 못이기는척 들어주는듯이 반응해야합니다. 우리는 고용된 경호원이니까요.",
    },
  },
};
