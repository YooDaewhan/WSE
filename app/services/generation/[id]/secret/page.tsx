...
> = {
  ...
  "1": {
    ...
    directorNote: {
      ...
      closing:
        "0기가 만든 첫 발자국이 1기, 2기, 그리고 그 이후 모든 기수의 지도가 됩니다. 길을 만들어주세요.",
    },
    classified: {
      ...
      items: [
        {
          label: "탈락한 5번째 멤버",
          content:
            "원래 새벽조는 5인 체제로 기획됐습니다. 5번째 멤버는 '예언자' 컨셉이었으나 캐릭터의 무게가 다른 멤버들과 충돌해 0기 출범 직전 제외됐습니다. 해당 컨셉은 추후 다른 기수에서 재활용될 예정입니다.",
        },
        {
          label: "흑길동 전환",
          content:
            "홍길동은 시즌 2에서 공식적으로 '흑길동'으로 이름이 전환될 예정입니다. 인종차별 논란을 사전에 차단하기 위한 시청자 반응 모니터링 기간을 거치고 있습니다.",
        },
        {
          label: "팀명 변경 가능성",
          content:
            "'새벽조'라는 이름은 임시 명칭이었으며, 1주년 시점에 멤버 투표로 정식 팀명을 확정할 예정이었습니다. 현재까지 변경 의사는 없습니다.",
        },
      ],
    },
    operations: {
      items: [
        {
          text: "멤버 간 친밀함을 너무 강하게 드러내지 마세요. 동지애 정도가 적절합니다.",
          level: "필수",
        },
        {
          text: "팀 활동에서 누구도 리더로 보이지 않도록 균등한 비중을 유지해주세요.",
          level: "필수",
        },
        {
  ...
  "2": {
    ...
    directorNote: {
      date: "2024년 6월 1일",
      opening:
        "스타터팩은 0기 새벽조의 '무거움'을 의도적으로 깬 기수입니다. 처음 시작하는 사람에게 정말 필요한 건 거창한 철학이 아니라 손에 쥘 수 있는 작은 도구라는 생각에서 출발했습니다.",
      origin:
        "포켓몬스터의 초반 3마리 컨셉이 출발점입니다. 어떤 모험가에게나 출발선에는 선택지가 있고, 그 선택이 여정의 색깔을 결정합니다. 불꽃(이그나이터), 방향(네비게이터), 축하(셀러브레이터) — 게임 메커닉을 캐릭터로 풀어낸 시도입니다. 0기보다 진입 장벽이 낮은 팀이 필요했습니다.",
      direction:
      ...
      items: [
        {
          label: "4번째 슬롯",
          content:
            "스타터팩은 원래 4인이었습니다. 4번째 컨셉은 '디펜더(Defender)'였으나, 4기 레스큐팩의 앵커와 역할이 겹쳐 통합 결정. 추후 게스트 형태로 재등장 가능성 있음.",
        },
        {
          label: "기수 순서 변경",
          content:
            "원래 기획 단계에서는 스타터팩이 0기, 새벽조가 1기로 순서가 반대였습니다. '시작'이라는 정체성을 어느 팀이 가져갈지를 두고 6개월간 논의 후 현재 순서로 확정.",
        },
        {
          label: "3주년 합본",
          content:
            "3주년에 0기 새벽조와 1기 스타터팩의 크로스오버 컨텐츠가 예정되어 있습니다. '먼저 길을 만든 자들과 그 길을 따라 오는 자들'이 컨셉.",
        },
      ],
    },
    operations: {
      items: [
        ...
        {
          text: "게임/모험 관련 컨텐츠 시 적극적으로 출연 의사를 밝혀주세요.",
          level: "요청",
        },
        {
          text: "다른 기수 멤버와의 합방 시 '먼저 다가가는' 역할을 맡아주세요.",
          level: "권고",
        },
        {
  ...
  "3": {
    ...
    directorNote: {
      ...
      origin:
        "'언더독이 이긴다'는 서사는 가장 오래된 클리셰지만, 그 클리셰가 살아남은 이유는 사람들이 그 이야기를 계속 필요로 하기 때문입니다. 히어로즈는 시청자 본인의 일상에 있는 '작은 영웅 순간'을 발견하게 만드는 거울 같은 팀입니다. 알바, 편돌이, 딸배, 폐급이병 — 모두 사회에서 '낮은' 위치로 분류되는 직군에서 출발합니다.",
      direction:
        "히어로즈는 자기 비하로 가면 망합니다. 자신의 위치를 알지만 그것이 끝이 아니라는 것을 보여주는 캐릭터들입니다. 연기자들끼리 '낮은 직군'을 우스개로 만들지 마세요. 진심으로 그 직업의 무게를 존중하는 자세가 필요합니다.",
      closing:
      ...
      items: [
        {
          label: "변신 시퀀스",
          content:
            "각 멤버는 시즌 2에서 '히어로 변신' 컨셉의 컨텐츠를 진행할 예정입니다. 일상복 → 영웅 모드의 시각적 전환이 핵심. 편돌이는 '프로그래머 영웅', 알바는 '얼음불 영웅', 딸배는 '바람의 라이더', 폐급이병은 '계급장 변신'.",
        },
        {
          label: "히어로즈 본부",
          content:
    ...
    operations: {
      items: [
        ...
        {
          text: "다른 멤버의 직군을 우스개로 삼지 마세요. 서로 존중이 필수입니다.",
          level: "필수",
        },
        {
        ...
        {
          text: "성장 서사를 직접 언급하기보다 행동으로 보여주세요.",
          level: "권고",
        },
        {
          text: "히어로즈 굿즈는 '실용성' 컨셉입니다. 액세서리류는 거의 제작되지 않습니다.",
          level: "인식",
        },
      ],
      teamNote:
        "히어로즈의 팬덤은 직장인, 알바생, 학생 등 '평범한 일상을 사는' 사람들이 주축입니다. 새벽 시간대 라이브, 출근길 짧은 컨텐츠, 점심시간 한 마디 — 일상에 스며드는 컨텐츠가 강하게 반응합니다.",
    },
  },
  /* ─────────── 3기 레스큐팩 ─────────── */
  "4": {
    ...
    directorNote: {
      ...
      origin:
        "기획 초기 컨셉은 '응급 구조대'였으나 너무 직접적이라는 의견에 따라 '정령'이라는 판타지 요소를 도입했습니다. 헬다이버는 관세음보살, 앵커는 발에 닻을 거는 자, 페인킬러는 다른 세계관에서 온 신의 사자. 각기 다른 구원의 형태를 한 팀에 담는 것이 목표였습니다.",
      direction:
    ...
    classified: {
      ...
      items: [
        ...
        },
        {
          label: "앵커 시점",
          content:
            "앵커의 프로필이 거꾸로 보이는 이유는 '시청자가 거꾸로 떨어지는 중'이라는 설정 때문입니다. 이 설정은 시즌 2 첫 화에서 본인이 직접 밝힙니다.",
        },
        {
          label: "페인킬러 결말",
          content:
            "페인킬러는 시즌 2 후반부에 자신의 능력을 더 이상 사용하지 않게 됩니다. '잊지 않기로 선택'하는 결말이 시즌 피날레의 핵심.",
        },
        {
          label: "스타터팩 크로스오버",
          content:
